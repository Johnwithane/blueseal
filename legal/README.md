...
8. **Payment-loss recovery, set-off, and payout holds (ToS §§ 7.7, 8.2, 8.4).** As a Stripe Connect platform (Express accounts, destination charges), Blue Seal — not the tradesperson — is what Stripe debits for lost chargebacks, dispute fees, negative balances, and seller-fraud losses; no contract wording changes that allocation vis-à-vis Stripe. §§ 7.7/8.2/8.4 therefore make those amounts a debt the tradesperson owes Blue Seal, recoverable by transfer reversal / connected-account debit, set-off, or direct invoice, with a payout-hold/reserve right. Lawyer to confirm: (a) the debit/reversal authorization is consistent with the Stripe Connected Account Agreement and Stripe's platform terms; (b) enforceability of the on-demand debt + set-off against BC sole-proprietor tradespeople; (c) whether the payout-hold right needs consumer-protection or payments-law qualifications.
