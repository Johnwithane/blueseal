...
- Tradespeople are **independent contractors**. They are not employees, agents, partners or representatives of Blue Seal.
- The agreement to perform work, the price of that work, scheduling, scope changes, and the quality of the work are matters **between the Client and the Tradesperson**.
- Blue Seal is **not a party** to any contract for work formed through the Service.
- Blue Seal does not endorse any Tradesperson and does not guarantee the suitability, quality, safety, legality, or accuracy of any service, listing, review or other content on the Service.
...
- be at least the age of majority in your province of residence (19 in British Columbia);
- have the legal capacity to enter into a binding contract;
- not be barred from using the Service under applicable law or by a prior suspension from us.

If you are creating an account on behalf of a business or organization, you confirm that you have authority to bind it to these Terms.

### 2.2 Account information

You agree to:

- give accurate, current and complete information when you sign up and keep it accurate as it changes;
- keep your password and access devices secure, not share your account, and notify us promptly at contact@blueseal.app of any unauthorized use of your account.

You are responsible for everything that happens through your account.

### 2.3 One account per person

You may not maintain more than one account for the same role. If you operate as both a Client and a Tradesperson, you may need separate accounts during the MVP period (see our public docs for the current state of dual-role support).

### 2.4 Tradesperson verification

If you sign up as a Tradesperson, you must additionally:
...
- reverse-engineer, decompile, disassemble or otherwise attempt to derive the source code of the Service except to the extent applicable law permits this;
- use the Service to compete with Blue Seal, or to build a competing product or dataset;
- interfere with security or rate-limiting features (including App Check), or test the Service's security without our prior written consent;
- use bots, automated agents, or AI tools to generate or post content that is presented as authentic human content (including fake reviews); or
- access any account other than your own, or any data that does not belong to you.

We may investigate suspected breaches of this section and take any action we reasonably think is appropriate — including warnings, removal of content, suspending or terminating accounts, and notifying authorities.

---

## 4. Verification — and its limits

Blue Seal carries out the following verification before a Tradesperson's profile becomes visible to Clients:

- a human administrator reviews each uploaded trade certification image against the issuing body, certificate number and expiry date the Tradesperson has submitted;
- a human administrator reviews the government-issued ID and confirms the name on the ID matches the name on the certification(s); and
- the Tradesperson must affirmatively agree to these Terms.
...
- **Own-policy liability release.** A Tradesperson who uploads their own liability policy that does **not** name Blue Seal as an additional insured must sign an in-Service release confirming that the policy does not cover Blue Seal, that they accept sole responsibility and liability for their work, and that they release the Blue Seal Parties from any claim arising from Blue Seal not being covered by that policy. (Where a policy **does** name Blue Seal as an additional insured, no release is required.)

These recorded acknowledgments, waivers, and releases form part of the agreement between the Client and the Tradesperson and between each of them and Blue Seal, and are kept as a record of the parties' informed consent. **They do not create, and must not be relied on as, insurance, a guarantee, or any assumption of liability by Blue Seal.** Nothing in this section limits §§ 4.1, 4.2, 14, 15 or 16, or any non-waivable right a Client has under applicable consumer-protection law. A Tradesperson's decision to work without insurance, and a Client's decision to engage a Tradesperson who is not insured, remain entirely their own.

---

## 5. Jobs, communications, and content

### 5.1 Requesting and accepting jobs

Clients can submit a request to a specific Tradesperson, including photos and a trade-specific intake form. Tradespeople choose whether to accept, propose terms, or decline. **A binding agreement for work, if any, is formed between the Client and the Tradesperson, not with Blue Seal.**

### 5.2 Chat messages

Chat threads are scoped to a specific job. For accountability and dispute support, **chat messages cannot be edited or deleted by users**. Be considerate of what you send. Don't share documents containing third parties' personal information through chat.

### 5.3 Your content

When you submit content to the Service (profile information, photos, intake forms, chat messages, reviews, invoices, AI prompts and outputs — together, "**Your Content**") you keep ownership of it, but you grant Blue Seal a **worldwide, non-exclusive, royalty-free licence** to host, store, copy, modify (only for technical purposes such as resizing or transcoding), use, distribute, display and transmit Your Content **for the purpose of operating, providing, improving and promoting the Service**. This licence ends when Your Content is removed from the Service, except:

- where retained under our retention schedule (see Privacy Policy § 6);
- where the content has been shared with other users who continue to use the Service (e.g., a public review of a Tradesperson);
- in anonymized or aggregated form.

You confirm that you have the rights necessary to grant this licence and that Your Content does not violate any law or third-party right (including privacy, publicity or copyright).

### 5.4 Our content

The Service itself, including its design, code, look and feel, trademarks, and the content we create (excluding Your Content and third-party content) is owned by Blue Seal or our licensors and is protected by intellectual-property laws. Except as the Service is intended to be used, we don't grant you any licence to it.

### 5.5 Feedback

If you send us feedback or suggestions about the Service, we may use them without obligation to you.

---

## 6. Reviews

### 6.1 Public reviews (Client → Tradesperson)

After a job is marked complete, a Client may publish a public review of the Tradesperson. Reviews must reflect the Client's genuine, first-hand experience and must not contain false statements, personal information about anyone other than the Tradesperson's professional identity, or unlawful content. We may remove or hide reviews that breach these Terms, that are subject to a credible defamation complaint, or that we reasonably believe are fraudulent or manipulated.

### 6.2 Private reviews (Tradesperson → Client)

Tradespeople may submit a private review of a Client they have worked with. These reviews are visible only to other verified Tradespeople (and to Blue Seal administrators), and contribute to a private Client reputation score. The same content standards apply.

### 6.3 No incentivized reviews

Neither party may offer or accept anything of value in exchange for a positive review or for withholding a negative review.
...
We may suspend, restrict, or terminate your account or your access to part of the Service, with or without notice, where:

- you have materially breached these Terms;
- we are required to do so by law, court order, or a regulator;
- your conduct exposes Blue Seal, our users, or any third party to legal, financial, reputational or safety risk;
...
We may make beta, preview, or experimental features available. These features may be modified, suspended, or removed at any time, are provided "as is" without warranty, and may have additional or different terms surfaced when you opt in. Feedback you give us about beta features is governed by § 5.5.

---

## 13. Service availability

We work to keep the Service available, but we do not guarantee uninterrupted, error-free, secure, or timely operation. The Service may be unavailable for maintenance, upgrades, force majeure, or because of issues with third-party providers. We are not liable for any loss caused by such unavailability, subject to § 14.
...
- **Indirect damages.** Blue Seal and our directors, officers, employees, contractors, and affiliates ("**Blue Seal Parties**") will not be liable for any indirect, incidental, special, consequential, exemplary or punitive damages, or for any loss of profits, revenue, goodwill, data, business opportunity, or substitute services, arising out of or relating to your use of the Service — even if we have been advised of the possibility of such damages.
- **Cap on direct damages.** The total aggregate liability of the Blue Seal Parties to you arising out of or relating to your use of the Service in any 12-month period will not exceed the greater of (i) the amounts you paid Blue Seal for the Service in that 12-month period, or (ii) **CAD $100**.

These limitations apply to the maximum extent permitted by law, regardless of the legal theory of the claim. They do not limit any liability that cannot be limited by law (including for fraud, gross negligence, or wilful misconduct, or for damages arising from death or personal injury caused by our negligence).

---

## 16. Indemnification

You agree to defend, indemnify and hold harmless the Blue Seal Parties from and against any claim, demand, loss, damage, liability, cost or expense (including reasonable legal fees) arising out of or relating to:
...
We may take over the defence and settlement of any claim subject to indemnification at our option, in which case you'll provide reasonable assistance.
...
If you have a dispute with us, please contact us at contact@blueseal.app **before starting any formal proceeding**. We agree to attempt in good faith to resolve the dispute informally for at least **60 days** from the date you tell us about it.

### 17.2 Arbitration

If a dispute is not resolved within 60 days, **you and Blue Seal agree to resolve any dispute arising out of or relating to these Terms or the Service by binding arbitration administered by the ADR Institute of Canada under its Arbitration Rules, before a single arbitrator, with the arbitration seated in Vancouver, British Columbia**. Judgment on the award may be entered in any court of competent jurisdiction.

### 17.3 Class-action waiver

**You and Blue Seal each agree that any dispute is to be brought only in our individual capacity, and not as a plaintiff or class member in any purported class, collective or representative proceeding.**

### 17.4 Exceptions — small claims, consumer protection, injunctive relief

The arbitration agreement and class-action waiver in this § 17 **do not apply** to:

- claims that may be brought in a small-claims court of competent jurisdiction (in BC, the Civil Resolution Tribunal or BC Provincial Court Small Claims division);
- any non-waivable right you have under the BC *Business Practices and Consumer Protection Act* or other applicable consumer-protection law; or
- a claim for injunctive or other equitable relief to protect intellectual-property rights or to enforce confidentiality obligations.

### 17.5 If arbitration is unenforceable

If § 17.2 or § 17.3 is held unenforceable, that part will be severed and the remainder of these Terms (including § 18) will continue to apply. Disputes that cannot be arbitrated will be brought exclusively in the courts of British Columbia, Canada, and you and Blue Seal each consent to the personal jurisdiction of those courts.

---

## 18. Governing law

These Terms and any dispute arising out of or relating to them or the Service are governed by the laws of British Columbia, Canada and the federal laws of Canada applicable there, without regard to conflict-of-laws principles. The *United Nations Convention on Contracts for the International Sale of Goods* does not apply.
...
- post the updated Terms on the Service and update the "Last updated" date;
- give notice through the Service or by email; and
- where the change reduces your rights, ask you to accept the new Terms the next time you sign in.

If you continue to use the Service after the change takes effect, you accept the updated Terms. If you don't accept them, your only remedy is to stop using the Service and close your account.

---

## 20. General

- **Entire agreement.** These Terms and the Privacy Policy are the entire agreement between you and Blue Seal regarding the Service and supersede any prior agreements on the same subject.
- **Severability.** If any provision is held unenforceable, the rest of the Terms remain in effect, and the unenforceable provision will be replaced by the closest enforceable equivalent.
- **No waiver.** Our failure to enforce any provision is not a waiver of our right to enforce it later.
- **Assignment.** You may not assign or transfer these Terms without our prior written consent. We may assign or transfer these Terms in connection with a business transaction (see Privacy Policy § 4.4) or to an affiliate.
- **No agency.** Nothing in these Terms creates an agency, partnership, joint venture, employment, or franchise relationship between you and Blue Seal.
- **Notices to you** may be given by email to the address on your account, or by posting in the Service. **Notices to us** must be sent to contact@blueseal.app.
- **Electronic agreement.** By ticking the agreement box at signup, you confirm that you are willing to receive these Terms and other contractual notices electronically, and that an electronic record is admissible to prove the agreement between us.
- **Language.** These Terms are drafted in English. If we provide a translation for convenience, the English version controls in case of any conflict.
