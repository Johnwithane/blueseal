  ...
  <div>
    ...
    <section class="relative overflow-hidden text-white">
      ...
      <div class="relative bs-container py-14 sm:py-20 text-center">
        ...
        <span class="bs-kicker justify-center !text-[color:var(--bs-light-blue)]">Help Center</span>
        ...
        <div class="bs-card overflow-hidden">
          <div class="grid md:grid-cols-[0.9fr_1.1fr]">
            <div class="relative overflow-hidden bs-gradient-deep p-8 text-white">
              <span class="bs-kicker !text-[color:var(--bs-light-blue)]">Still need help?</span>
              ...
              <ul class="mt-5 space-y-2 text-sm text-white/85">
                <li class="flex items-center gap-2"><i class="pi pi-check-circle text-[color:var(--bs-light-blue)]"></i> Real people, real answers</li>
                <li class="flex items-center gap-2"><i class="pi pi-check-circle text-[color:var(--bs-light-blue)]"></i> We can review the job, chat & invoice</li>
              </ul>
              <SealCharacter
                name="scene-support"
